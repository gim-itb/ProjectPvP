...
public abstract class Core : MonoBehaviour
{
    ...
    public abstract void Hurt(HitRequest hitRequest, ref HitResult hitResult);
    public Action<HitRequest, HitResult> OnHurt;

    public static Action<Core> StaticOnEntityUnfreeze;
}
